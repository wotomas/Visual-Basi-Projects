...
#End Region
    ...
    Private Sub picImage_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles picImage.MouseDown
        Dim mainPixel As Color = GetPixel(image, e.X, e.Y)
        'MsgBox("RGB values: " + mainPixel.R.ToString + " " + mainPixel.G.ToString + " " + mainPixel.B.ToString)
        frmBgRemoval.changeButtonBackColor(Color.FromArgb(mainPixel.R, mainPixel.G, mainPixel.B), e.X, e.Y)
        'MsgBox(frmBgRemoval.colorButton.BackColor.ToString)
        RemoveDashRect()
